<template>
  <div class="app-container">
    ...
    <div class="sub-navbar"
         v-permission='["platform:system:version:create"]'>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button type='info'
                       ...
                       v-permission='["platform:system:version:edit"]'
    ...
    <el-dialog :title="dialogForm.title"
      ...
      <el-form :model="dialogForm">
        ...
        <el-form-item label="是否需要强制更新"
                      :label-width="formLabelWidth">
          <!--<el-checkbox v-model="dialogForm.updateFlag">是</el-checkbox>-->
          <el-switch
        ...
        <el-form-item label="上传安装包"
          ...
          <single-file-uploader @update='updateFile'
                                uploadUrl='auth/systemVersion/uploadPackage'
  ...
  export default {
    ...
    methods: {
      handleEdit: _.debounce(function (index, row) {
        ...
        AXIOS.post('/auth/systemVersion/view', {id}).then(res => {
          this.dialogForm = res || {}
      ...
      updateFile(file) {
        this.dialogForm.downloadUrl = file
      },
      ...
      confirmBannerDialog: _.debounce(function () {
        ...
        if (currentStatus == 'preview') {
          ...
          if (self.validForm()) {
            const apiUrl = currentStatus == 'edit' ? '/auth/systemVersion/edit' : '/auth/systemVersion/create'
      ...
      getList() {
        ...
        AXIOS.post('/auth/systemVersion/index', self.listQuery).then(res => {
