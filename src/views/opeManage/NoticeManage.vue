        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button @click='handlePreview(scope.$index, scope.row)'
                       v-permission='["platform:cms:article:view"]'
                       size="mini">
              查看
            </el-button>
            ...
            <el-button type='info'
                       ...
                       v-permission='["platform:cms:article:edit"]'
                       size="mini">
              编辑
            </el-button>
            ...
            <el-button
              ...
              v-permission='["platform:cms:article:enable"]'
            ...
            <el-button
              size="mini"
              type="danger"
              v-permission='["platform:cms:article:delete"]'
    ...
    methods: {
      handlePreview(index, row) {
        ...
        AXIOS.post('/auth/cmsArticle/viewArticle', {id}).then(res => {
          self.previewName = res.name
          self.previewContent = res.content || 'fc'
