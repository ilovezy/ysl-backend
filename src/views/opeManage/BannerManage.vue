<template>
  <div class="app-container">
    <div class="sub-navbar"
         v-permission='["platform:cms:banner:create"]'>
    ...
    <div class='main-table-wrap'>
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button type='info'
                       v-permission='["platform:cms:banner:edit"]'
            ...
            <el-button
              ...
              v-permission='["platform:cms:banner:enable"]'
            ...
            <el-button
              size="mini"
              type="danger"
              v-permission='["platform:cms:banner:delete"]'
