    ...
    <div class='main-table-wrap'>
      <el-table
        ...
        <el-table-column
          ...
          label="借款人信息">
          <template slot-scope="scope">
            <user-info-control type='repayingOrder' :member-id='scope.row.memberId'></user-info-control>
          </template>
        </el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        AXIOS.post('/auth/loanManage/OrderInReturnIndex', self.listQuery).then(res => {
